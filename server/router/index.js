...
router.get('/actions/:id',actionContoller.getActionsById)
router.post('/actions',actionContoller.addAction)
router.get('/restaurants',restaurantsController.getRestaurantss)
router.post('/restautants',restaurantsController.addRestaurants)
