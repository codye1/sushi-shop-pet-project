...
interface CardProductBasket{
    product:Product
}

const CardProductBasket:React.FC<CardProductBasket> = ({product}) => {
        ...
        <div className='card-product-basket'>
            ...
            <div className='card-product-basket-right-cont'>
                ...
                <div className='card-product-basket-price-cont'>
                 ...
                 :product.action>0? <div className="action-basket">{price} грн&nbsp;<span>{product.price}</span></div> : <span>{product.price}</span>

                }

                </div>
                <div onClick={()=>{
                    dispatch(deleteAllElementsByIdFromBasket(product))
                }} className='card-product-basket-delete-button-cont'>
