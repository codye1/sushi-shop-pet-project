...
const BasketReccomendationSlider:React.FC<IProductsInXEelement> = ({products}) => {
        ...
        <div className="d-flex">
            <div className="container">
                ...
                <div className="pageByIdProduct-swiper-cont">
                    <RecommendationSlider refs={["div.prev-button-basket.pointer","div.next-button-basket.pointer"]}  products={products} />
                </div>
            </div>
        </div>
    );
