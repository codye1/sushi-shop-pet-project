                    ...
                    <div className="modal-slider-in-slider column">
                        ...
                        <>
                            ...
                            {promotion.promotionalCode?
                                <a href={`/promotions/${promotion.id}`} className='modal-slider-button'>Застосувати промокод</a>
                                :
                                <a href={`/promotions/${promotion.id}`} className='modal-slider-button'>Детальніше</a>
                            }
                        </>
                        :
                            <a href={`/promotions/${promotion.id}`} className='modal-slider-button'>Перейти</a>
                        }
                    </div>
                </div>
            </div>
