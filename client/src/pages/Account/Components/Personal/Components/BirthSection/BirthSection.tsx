    ...
    <div className="birth-date-section">
      {birthDate.length > 0 ? (
        <div className="section-info section-birth d-flex">
          <img
            src="https://uzhhorod.sushi-master.ua/img/account/personal/cake.svg"
            alt=""
          />
          <div className="section-info-content">
            ...
            <p className="d-flex">
              ...
              &nbsp;&nbsp;&nbsp;
              <Tooltip
                title="Змінити дату можна тільки за допомогою оператора"
                arrow
              >
                <img
                  src="https://uzhhorod.sushi-master.ua/img/custom/info.svg"
                  alt=""
                />
              </Tooltip>
            </p>
        ...
        <>
          <h2 className="sub-title">
            {t('account.personal.sections.birth.sub-title')}
          </h2>
          <div className="pick-birth d-flex space-between align-center pointer">
            <button
              onClick={handleClickCalendar}
              className="comps d-flex space-between align-center pointer"
            >
              <div className="borederd"></div>
              <div className="placeholder">
                {t('account.personal.sections.birth.date-placeholder')}
              </div>
              <img
                src="https://uzhhorod.sushi-master.ua/img/account/personal/calendar.svg"
                alt=""
              />
            </button>
            ...
            >
              <div className="title d-flex center">
                {t('account.personal.sections.birth.modal-datepicker.title')}
              </div>
              <div className="description d-flex center">
                {t(
                  'account.personal.sections.birth.modal-datepicker.description'
                )}
              </div>
              <TwoButtons
                cancelTitle={t(
                  'account.personal.sections.birth.modal-datepicker.two-buttons.cancel'
                )}
                applyTitle={t(
                  'account.personal.sections.birth.modal-datepicker.two-buttons.apply'
                )}
          ...
          <div className="birth-warn d-flex">
            <img
              src="https://kyiv.sushi-master.ua/img/account/personal/warning.svg"
              alt=""
            />
