...
const CustomInput = ({
  ...
  return (
    <label className="cutom-input">
      <label
        className={
          isFocused || value.length > 0 ? 'input-focused' : 'input-notfocused'
        }
      >
        {required ? (
          <>
      ...
      {value.length < 2 && isFocused && required ? (
        ...
        <>
          <div onClick={onApplyButtons} className="apply">
            {t('components.CustomInput.buttons.apply')}
          </div>
          <div onClick={onCancelButtons} className="cancel">
            {t('components.CustomInput.buttons.cancel')}
          </div>
        </>
      ) : (
